// status: rascunho — ancorado nos números reais publicados pela envs
// ("+50 mil usuários simultâneos", setor educação), mas o cliente é ilustrativo.
// Trocar pelo case real ANTES de publicar (content/landing-copy.md §5).

export const caseDestaque = {
  verificado: false,
  eyebrow: "CASE DE DESTAQUE",
  ...
  depois: "Plataforma real, no ar, com base ativa e picos de 50 mil alunos ao mesmo tempo. Evoluída de MVP para produto completo.",
  numero: "+50 mil",
  numeroLabel: "usuários simultâneos após o lançamento",
  cta: "Quero um resultado assim",
  clienteUrl: "", // sem link enquanto o case for rascunho
  clienteLabel: "meduca",
};
